    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1D3F4F] via-[#2A5A6B] to-[#1D3F4F]">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white font-serif font-medium leading-7 text-5xl">BOOKINGS</h1>
        </div>
      </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-2">{booking.treatment}</h3>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    ...
                    {/* Booking Details */}
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white/80 mb-2">{booking.treatment}</h3>
                      <div className="space-y-2">
