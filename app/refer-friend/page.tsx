...
export default function ReferFriendPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1D3F4F] via-[#2A5A6B] to-[#1D3F4F]">
      ...
      <div className="relative h-80 overflow-hidden mb-[30px]">
        <div className="absolute inset-0">
          <img src="/happy-friends-sharing-rewards-and-referrals-togeth.jpg" alt="Friends sharing rewards" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div className="text-white">
            <h1 className="mb-4 font-serif font-medium text-5xl">Refer a Friend</h1>
            <p className="text-xl text-white/90">Share the beauty experience with your friends</p>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-2xl p-8 border-gray-100 border mx-0 my-0 leading-7 tracking-normal mb-10">
          {/* Send Referral Form */}
          <div className="mb-12">
            <h2 className="text-2xl font-medium text-gray-800 mb-8 text-center">Send Referral</h2>
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-2">
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-3 pr-8 focus:ring-2 focus:ring-[#DC7867] focus:border-[#DC7867] transition-colors"
                    >
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#ec8a4a] to-[#dc7867] hover:from-[#dc7867] hover:to-[#ec8a4a] text-white rounded-lg text-lg font-medium transition-all duration-200 hover:shadow-lg py-[15px] px-0 h-[42px]"
              >
                Send Referral
              </Button>
            </div>
          ...
          <div className="text-center border-t border-gray-200 pt-8">
            <div className="w-20 h-20 bg-gradient-to-br from-[#DC7867]/20 to-[#ec8a4a]/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <Gift className="w-10 h-10 text-[#DC7867]" />
            </div>
            <h3 className="text-2xl font-medium text-gray-800 mb-4">Earn Rewards</h3>
