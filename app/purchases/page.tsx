    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1D3F4F] via-[#2A5A6B] to-[#1D3F4F]">
      ...
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white font-serif font-medium leading-7 text-5xl">PURCHASES</h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white/5 backdrop-blur-sm border-white/10 rounded-xl p-1 flex border flex-row gap-3">
            <button
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    {/* Date Circle */}
                    <div className="bg-gradient-to-r from-[#ec8a4a] to-[#dc7867] rounded-full w-16 h-16 flex flex-col items-center justify-center text-white">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-2">{purchase.treatment}</h3>
                  ...
                  {/* Actions */}
                  <div className="flex items-center space-x-2">
                    <Button className="bg-gradient-to-r from-[#ec8a4a] to-[#dc7867] hover:from-[#dc7867] hover:to-[#ec8a4a] text-white px-4 py-2 rounded-xl transition-all duration-200">
                      View Receipt
                    </Button>
            ...
            historyPurchases.map((purchase) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-4">
                    {/* Date Circle */}
                    <div className="bg-white/20 rounded-full w-16 h-16 flex flex-col items-center justify-center text-white/70">
                      <span className="text-xs font-medium">{purchase.dateShort}</span>
                      <span className="text-xs">{purchase.year}</span>
                    </div>
                    ...
                    {/* Purchase Details */}
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white/80 mb-2">{purchase.treatment}</h3>
                      <div className="space-y-2">
